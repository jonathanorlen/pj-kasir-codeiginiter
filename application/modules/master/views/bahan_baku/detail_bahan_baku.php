              ...
              <div class="row">
                ...
                <div class="form-group  col-xs-6">
                  ...
                  <div class="input-group">
                    ...
                    $hasil_bb = $bb->row();
                    ?>
                    <span class="input-group-addon"><?php if(empty($param)){ echo $hasil_bb->kode_bahan_baku.'_'; } ?></span>
                    <input type="hidden" id="kode_setting" value="<?php echo @$hasil_bb->kode_bahan_baku ?>"></input>
                    <input required name="kode_bahan_baku" value="<?php echo @$hasil_bahan_baku->kode_bahan_baku ?>"  <?php if(!empty($param)){ echo "readonly='true'"; } ?> type="text" class="form-control" id="kode_bahan_baku" />
                  </div>
                </div>
                <div class="form-group  col-xs-6">
                  <label class="gedhi"><b>Nama Produk</label>
                  <input disabled value="<?php echo @$hasil_bahan_baku->nama_bahan_baku; ?>" type="text" class="form-control" name="nama_bahan_baku" />
                </div>
                <div class="form-group  col-xs-6">
                <label class="gedhi"><b>Kategori Produk</label>
                <select  class="form-control stok select2" name="kode_kategori_produk" disabled>
                ...
                <!-- <div class="form-group  col-xs-5">
                    ...
                    <?php 
                        ...
                        <input  value="stok" name="jenis_bahan"  id="jenis_bahan"type="hidden" class="form-control" readonly />
                <div class="form-group  col-xs-6">
                ...
                <div class="form-group  col-xs-6">
                  ...
                  ?>
                  <select disabled name="kode_rak" id="kode_rak" class="form-control">
                    ...
                    <div class="form-group  col-xs-6">
                      ...
                      ?>
                      <select disabled class="form-control select2 pembelian" name="id_satuan_pembelian">
                    ...
                    <div class="form-group  col-xs-6">
                      ...
                      <select disabled class="form-control stok select2" name="id_satuan_stok">
                        ...
                        <div class="form-group  col-xs-6">
                          ...
                          <input disabled type="text" class="form-control" name="harga_jual_3" value="<?php echo @$hasil_bahan_baku->status ?>" />
                        </div>
