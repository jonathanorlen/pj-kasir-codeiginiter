        ...
        <div class="box-body">            
          ...
          <div id="cari_penjualan">
            <div>
              ...
              <span><label><h4><strong>Total Keuangan Penjualan :<?php echo format_rupiah($keuangan); ?></strong></h4></label></span><br/>
            ...
            <table id="tabel_daftar" class="table table-bordered table-striped" style="font-size:1.5em;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="right"><?php echo format_rupiah(@$daftar->grand_total-@$daftar->nominal_retur); ?></td>
