                            ...
                            <div class="box-body">
                              ...
                              ?>
                                <div class="col-md-6">
                                    <div class="box-body">
                                      <div class="callout callout-info">
                                        <span style="font-weight:bold; font-size:1.5em;"><i class="fa fa-barcode"></i>&nbsp;&nbsp;&nbsp; Kode Penjualan &nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;</span>
                                        <span style="text-align:right; font-size:1.5em;"><?php echo @$list_penjualan_row->kode_penjualan; ?></span>
                                ...
                                <div class="col-md-6">
                                    <div class="box-body">
                                      <div class="callout callout-info">
                                        <span style="font-weight:bold;font-size:1.5em;"><i class="fa fa-calendar"></i>&nbsp;&nbsp;&nbsp; Tanggal Penjualan &nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;</span>
                                        <span style="text-align:right;font-size:1.5em;" id="tanggal_spoil"><?php echo tanggalIndo(@$list_penjualan_row->tanggal_penjualan); ?></span>
                                      </div>
                                    </div>
                                </div><br><br>
