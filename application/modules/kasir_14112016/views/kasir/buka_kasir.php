                        ...
                        <div class="box-body">            
                          <div class="row">
                            <div class="form-group  col-xs-5">
                              ...
                              <input readonly="true" value="<?php echo @$hasil_kode_penjualan->kode_kasir."_".date("dmyHis")."_".$nomor_kasir."_".$id_kasir."_".$no_belakang ?>" type="text" class="form-control" name="kode_transaksi" />
