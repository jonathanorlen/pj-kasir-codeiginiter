                      ...
                      <div class="theme-option">
                        ...
                        <h3 class="page-title">
                          ...
                          <div class="row">
                            <div class="col-lg-6 col-md-3 col-sm-6 col-xs-12">
                              <a class="dashboard-stat dashboard-stat-light blue-soft" id="penjualan">
                                <div class="visual">
                            ...
                            <div class="col-lg-6 col-md-3 col-sm-6 col-xs-12">
                              <a class="dashboard-stat dashboard-stat-light blue-soft"  id="menu">
                                <div class="visual">
                        ...
                        <script type="text/javascript">
                          $(document).ready(function(){
                            ...
                            $("#menu").click(function(){
                              window.location = "<?php echo base_url() . 'laporan/laporan_menu' ?>";
                            });
