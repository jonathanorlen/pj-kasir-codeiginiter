...
<div class="tunggu" style="z-index:9999999999999999; background:rgba(51, 50, 50, 0.8); width:100%; height:100%; position:fixed; top:0; left:0; text-align:center; padding-top:25%; display: none;" >
  ...
  <div data-role="page" id="homepage" data-theme="b">
   ...
   <div role="main" class="ui-content" style="padding: 40px;margin-left: 70px;">
    ...
    color: #ca2c2c;"><p align="center">SELAMAT DATANG DI PATRIOT JAYA - KASIR</p></h2>
    ...
    <nav class="main-nav">
      <ul>
        <li style="background-color: rgb(203, 32, 37);cursor: pointer;" class="hoveren">
          <a id="das" data-transition="slidefade">
            <img src="<?php echo base_url().'template/images/icons/white/team.png' ?>" alt="" title="" /><span>Dashboard</span></a>
          </li>
          <?php
            if($user->jabatan=="005" OR $user->jabatan=="99"){
          ?>
          <li style="background-color: rgb(248, 179, 52);cursor: pointer;" class="hoveren">
            <a id="taking_order" data-transition="slidefade">
              <img src="<?php echo base_url().'template/images/icons/white/briefcase.png' ?>" alt="" title="" /><span>Taking Order</span></a>
            </li>
            <?php } ?>

            <?php if($user->jabatan=="004" OR $user->jabatan=="99"){ ?>
            <li style="background-color: rgb(151, 191, 13);cursor: pointer;" class="hoveren">
              <a id="kasir" data-transition="slidefade">
                <img src="<?php echo base_url().'template/images/icons/white/blog.png' ?>" alt="" title="" /><span>Kasir</span></a>
              </li>
            <?php } ?>  

            <?php if($user->jabatan=="007" OR $user->jabatan=="99"){ ?>
              <li style="background-color: rgb(45, 90, 255);cursor: pointer;" class="hoveren">
                <a id="transaksi" data-transition="slidefade">
                  <img src="<?php echo base_url().'template/images/icons/white/photos.png' ?>" alt="" title="" /><span>Transaksi Kasir</span></a>
                </li>
                <?php } ?>  

                <?php if($user->jabatan=="004" OR $user->jabatan=="99"){ ?>
                <li style="background-color: rgb(195, 47, 81);cursor: pointer;" class="hoveren">
              <a id="retur_penjalan" data-transition="slidefade">
                <img src="<?php echo base_url().'template/images/icons/white/contact.png' ?>" alt="" title="" /><span>Retur Penjualan</span></a>
              </li>
              <?php } ?>

               <?php if($user->jabatan=="004" OR $user->jabatan=="99" OR $user->jabatan=="007"){ ?>
                <li style="background-color: rgb(121, 74, 173);cursor: pointer;" class="hoveren">
                <a id="laporan" data-transition="slidefade">
                  <img src="<?php echo base_url().'template/images/icons/white/docs.png' ?>" alt="" title="" /><span>Laporan Penjualan</span></a>
                </li>
                <?php } ?>

                 <?php if($user->jabatan=="004" OR $user->jabatan=="99"){ ?>
                <li style="background-color: rgb(26, 109, 60);cursor: pointer;" class="hoveren">
                <a id="list_pengiriman" data-transition="slidefade">
                  <img src="<?php echo base_url().'template/images/icons/white/toggle.png' ?>" alt="" title="" /><span>List Pengiriman</span></a>
                </li>
                <?php } ?>
