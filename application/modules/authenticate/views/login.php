...
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="login" style="background: url(component/img/kasir.png)no-repeat center center fixed !important;
-webkit-background-size: cover !important;
  ...
  <div class="content">
    ...
    <form class="login-form" action="<?php echo base_url($this->cname).'/login'; ?>" method="post">
      <h3 class="form-title"><img src="<?php echo base_url() . 'component/img/icon-kasir.png  '?>" alt="" style="width:150px;height:auto;"/></h3>
      <div class="alert alert-danger display-hide">
        ...
        <div class="form-actions">
          ...
          <div class="create-account" style="background:#29166f;">
            <p>
              <a id="register-btn" class="uppercase">PATRIOTJAYA-KASIR</a>
            </p>
          </div>
        </form>
        <!-- END LOGIN FORM -->
